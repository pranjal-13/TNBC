...
Feature: Onus Payment flow feature
  ...
  Scenario Outline: Onus Payment flow
    ...
    Examples: 
      ...
      |                 | INTERNAL CHEQUE | Cheque No | EQUAL  | 38020270 |               |
...
@TC_15_02_OnusReturnpaymentflow
  Scenario Outline: Onus Return Payment flow
    ...
    Examples: 
      ...
      |                 | INTERNAL CHEQUE | Cheque No | EQUAL  | 38020265 |     | 01-Stop Payment Check | 02-Insufficient Fund | 04-The Account is closed | 05-Un-matched signature | 07-Un-endorsable check | 08-Missing date | 09-Presented before date | 10-Un-Authorized alteration | 11-Giro error | 14-Missing Clearing Stamp | 16-Wrong Date | 17-Collateral Check | 18-Witness Signature Missing | 15-Amount Numbers and Words mismatch | 23-Crossed check un-compliance | Return |
...
@TC_15_03_Onuspaymentflow-VIP
  Scenario Outline: Onus VIP Payment flow
    ...
    Examples: 
      | ValueDateperiod | PaymentType     | Reference | SubRef | ChequeNo | AccountNumber |
      |                 | INTERNAL CHEQUE | Cheque No | EQUAL  | 38020263 |               |
  ...
  Scenario Outline: Onus VIP Return Payment flow
    ...
    Examples: 
      ...
      |                 | INTERNAL CHEQUE | Cheque No | EQUAL  | 38020264 |               | 01-Stop Payment Check | 02-Insufficient Fund | 04-The Account is closed | 05-Un-matched signature | 07-Un-endorsable check | 08-Missing date | 09-Presented before date | 10-Un-Authorized alteration | 11-Giro error | 14-Missing Clearing Stamp | 16-Wrong Date | 17-Collateral Check | 18-Witness Signature Missing | 15-Amount Numbers and Words mismatch | 23-Crossed check un-compliance |
  ...
  Scenario Outline: Onus Duplicate Payment flow
    ...
    Examples: 
      | ValueDateperiod | PaymentType     | Reference | SubRef | ChequeNo | AccountNumber |
      |                 | INTERNAL CHEQUE | Cheque No | EQUAL  | 38020262 |               |
  ...
  Scenario Outline: Onus Payment flow for sending Duplicate Cheque to Repair queue
    ...
    Examples: 
      ...
      |                 | INTERNAL CHEQUE | Cheque No | EQUAL  | 38020265 |               | Return |
 ...
 #@TC_15_08_OnusPaymentRepairFlow
  ...
  Scenario Outline: Inward Payment flow
    ...
    Examples: 
      | ValueDateperiod | PaymentType     | Reference | SubRef | ChequeNo | AccountNumber |
      |                 | INTERNAL CHEQUE | Cheque No | EQUAL  | 38020265 |               |
